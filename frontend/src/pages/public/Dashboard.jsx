...
const actions = [
  {
    title: "Flood Alerts",
    description: "View the latest flood warnings and safety alerts.",
    to: "/alerts",
    icon: Bell,
  },
  {
    title: "Flood Map",
    description: "View flood zones and affected locations on the map.",
    to: "/map",
    icon: Map,
  },
  {
    title: "Report Flood",
    description: "Submit a flood incident report from your area.",
    to: "/reports/submit",
    icon: TriangleAlert,
  },
  {
    title: "My Reports",
    description: "Track the flood reports you have submitted.",
    to: "/reports/my",
    icon: FileText,
  },
  {
    title: "Community",
    description: "View verified reports shared by the community.",
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-blue-100">
                Monitor flood information, submit incident reports,
                and manage alerts for your area.
              </p>
            </div>
        ...
        <section className="mt-10">
          <div className="mb-5">
            ...
            <p className="mt-1 text-sm text-slate-600">
              Access the main FloodGuard services from your dashboard.
            </p>
          </div>
            ...
            {actions.map((action) => {
              ...
              return (
                <Link
                  key={action.to}
                  to={action.to}
                  className="group rounded-xl border border-blue-100 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:border-blue-300 hover:shadow-md"
                >
