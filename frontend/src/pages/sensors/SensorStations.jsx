...
import { isWithinNepalOperationalBounds, normalizedOperationalCoordinatePair } from "../../components/map/mapUtils";
            ...
            {paginatedStations.map((station) => (
              <article key={station.id} className="rounded-2xl border border-blue-100 bg-white p-6 shadow-sm">
                <div className="flex items-start justify-between gap-4">
                  ...
                  {!normalizedOperationalCoordinatePair(station.latitude, station.longitude) && <span className="rounded-full bg-red-100 px-3 py-1 text-xs font-bold uppercase text-red-700">Location outside Nepal</span>}
                </div>
